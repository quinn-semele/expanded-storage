...
object Constants {
    ...
    const val FABRIC_API_VERSION = "0.104.0+1.21.1"
    ...
    const val NEOFORGE_VERSION = "21.1.51" // https://projects.neoforged.net/neoforged/neoforge/
