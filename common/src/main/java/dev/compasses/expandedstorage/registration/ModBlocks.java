...
public class ModBlocks {
    ...
    public static final ShulkerBoxBlock SHULKER_BOX = register("shulker_box", new ShulkerBoxBlock(BlockBehaviour.Properties.ofFullCopy(Blocks.SHULKER_BOX), BlockColor.NONE));
